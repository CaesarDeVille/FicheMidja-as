...
const DEFAULT_COMP_META = {
  'pri_Identification': { desc: 'Analyser objets, créatures et artefacts pour en révéler la nature.', effet: '**Novice :** Identifier si un objet est magique et sa civilisation d\'origine.\n**Adepte :** Connaître les propriétés magiques d\'un objet, les caractéristiques d\'une créature, l\'âge d\'un objet et les propriétés de plantes.\n**Expert :** Identifier la fonction d\'objets anciens et connaître les points faibles d\'une créature.\n**Maître :** Savoir sans jet si un objet est magique et connaître les effets exacts d\'un objet maudit.' },
  'pri_Marchandage': { desc: 'Négocier prix, contrats et transactions commerciales.', effet: '**Novice :** Meilleurs prix chez les marchands indépendants. Permet de négocier un contrat.\n**Adepte :** Négociations possibles avec les marchands en boutique. Permet de négocier le prix des compétences et expertises.\n**Expert :** Négocier l\'achat et la vente de caisses de marchandises, le prix des sorts dans les académies et renégocier un contrat en cours.\n**Maître :** Vraiment bons prix. Négocier avec des marchands de compagnie et renégocier un contrat terminé.' },
  'pri_Désamorçage': { desc: 'Crocheter serrures et désamorcer pièges de toutes complexités.', effet: '**Novice :** Crocheter serrures simples de portes et coffres. Identifier si un coffre est piégé.\n**Adepte :** Crocheter portes et coffres sécurisés avancés. Désamorcer les coffres pièges.\n**Expert :** Désamorcer des pièges. Crocheter serrures complexes de coffres forts et portes de maître.\n**Maître :** Crocheter coffres forts et serrures anciennes. Un maître sait sans jet si une serrure est piégée.' },
  'pri_Vol à la tire': { desc: 'Subtiliser objets et pièces sur une cible sans se faire repérer.', effet: '**Novice :** Voler quelques pièces dans la bourse de quelqu\'un.\n**Adepte :** Fouiller les poches de quelqu\'un.\n**Expert :** Fouiller le sac de quelqu\'un.\n**Maître :** Voler des bijoux portés et armes accrochées.' },
  'pri_Médecine': { desc: 'Soigner blessures et sauver des vies avec un kit de soin.', effet: '**Novice :** Soigner avec un kit les blessures simples, ou une blessure grave par kit. `Les Kits soignent 3 PdV`\n**Adepte :** Soigner toutes les blessures d\'une personne avec un kit. `Les Kits soignent 3.5 PdV`\n**Expert :** Soigner toutes les blessures de deux personnes avec un seul kit. `Les Kits soignent 4 PdV`\n**Maître :** Soigner jusqu\'à 4 personnes avec un kit et __recoudre un membre coupé__ contre un kit. `Les Kits soignent 5 PdV`' },
  'pri_Artisanat / Réparation': { desc: 'Réparer équipements et créer des objets aux postes d\'artisanat.', effet: '**Novice :** Réparer l\'équipement cassé.\n**Adepte :** Créer des armes et objets aux postes d\'artisanat. Réparer des équipements magiques cassés.\n**Expert :** Réparer des Mécanoïdes blessés et mécanismes anciens. Bonus de 1 au craft.\n**Maître :** Chance de réparer un objet brisé. Bonus de 2 au craft.' },
  'pri_Alchimie': { desc: 'Préparer potions et reconnaître les herbes de la nature.', effet: '**Novice :** Préparer des potions simples et reconnaître les herbes dans la nature.\n**Adepte :** Faire des potions adeptes issues de mélanges.\n**Expert :** Faire des potions blanches.\n**Maître :** Faire des potions noires.' },
  'pri_Chasse / Pistage': { desc: 'Suivre des traces, dépecer proies et monstres.', effet: '**Novice :** Repérer des traces et les suivre. Dépecer des animaux pour leur viande et ressources.\n**Adepte :** Dépecer également des monstres et créatures rares.\n**Expert :** Reconnaître le type de proie et depuis combien de temps il est passé.\n**Maître :** Savoir le type d\'armure portée, le nombre de cibles et leur vitesse.' },
  'pri_Dressage': { desc: 'Dresser et commander des animaux intelligents.', effet: '**Novice :** Avoir un animal intelligent et social qui suit et protège son maître.\n**Adepte :** L\'animal n\'a plus peur des créatures invoquées et morts-vivants de son maître.\n**Expert :** Avoir 2 animaux.\n**Maître :** L\'animal peut obéir à des ordres complexes.' },
  'pri_Acrobaties': { desc: 'Grimper, sauter et attaquer depuis les hauteurs.', effet: '**Novice :** Grimper sur un bâtiment en prenant son temps.\n**Adepte :** Grimper sur un bâtiment sans bruit.\n**Expert :** Grimper rapidement et sauter de toits en toits.\n**Maître :** Attaque d\'opportunité depuis un toit ou rambarde (d13). EDP sans armure/bouclier = d14.' },
  'pri_Cuisine': { desc: 'Cuisiner des plats nourrissants avec des effets de repos.', effet: '**Novice :** Cuisiner des plats à base d\'ingrédients frais à utiliser comme des rations.\n**Adepte :** Cuisiner des plats *Bien Nourri* : +1 PV Max jusqu\'au prochain long repos.\n**Expert :** Transformer de la viande en rations via un séchoir, ou cuisiner de la chair de monstre.\n**Maître :** Cuisiner des *Plats de Gourmets*. *Très Bien Nourri* : +1.5 PV, PS et PE jusqu\'au long repos.' },
  'sec_Équitation': { desc: 'Maîtriser les montures au combat et à distance.', effet: '**Novice :** La monture ne fuit plus au combat.\n**Adepte :** Bonus de 1 d\'équipement quand monté avec une lance ou une épée.\n**Expert :** Utiliser une arme à distance ou lancer des sorts depuis une monture sans désavantage.\n**Maître :** Donner des ordres complexes à distance et appeler sa monture. Elle trouve toujours un moyen de suivre son maître.' },
  'sec_Navigation': { desc: 'Naviguer des voiliers de toutes tailles.', effet: '**Novice :** Naviguer un bateau doté d\'un mât.\n**Adepte :** Naviguer un deux-mâts.\n**Expert :** Naviguer un trois-mâts. +1 case de vitesse aux navires.\n**Maître :** Bonus de 3 aux tirs de canon.' },
  'sec_Ambidextrie': { desc: 'Utiliser les deux mains efficacement au combat.', effet: '**Novice :** Utiliser une arme dans la main faible sans malus.\n**Adepte :** Jeter ou utiliser des objets (potions, consommables) en se défendant.\n**Expert :** Lancer des sorts et se défendre au CàC en même temps. -1 au malus d\'encerclement avec deux armes.\n**Maître :** Arme à feu dans la main faible au CàC en se défendant. Annule le malus d\'encerclement avec une arme dans chaque main.' },
  'sec_Musculation': { desc: 'Entraîner son corps pour augmenter ses points de vie.', effet: '**Novice :** +1 PV maximum.\n**Adepte :** +2 PV maximum.\n**Expert :** +3 PV maximum.\n**Maître :** Porter à une main une arme à deux mains, sans leur bonus contre les armures.' },
  'sec_Méditation': { desc: 'Apaiser son esprit pour augmenter ses points de santé mentale.', effet: '**Novice :** +1 PS maximum.\n**Adepte :** +2 PS maximum.\n**Expert :** +3 PS maximum.\n**Maître :** Méditer permet de faire baisser sa dissonance au palier de 5 en dessous.' },
  'sec_Athlétisme': { desc: 'Développer son endurance pour augmenter ses points d\'endurance.', effet: '**Novice :** +1 PE maximum.\n**Adepte :** +2 PE maximum.\n**Expert :** +3 PE maximum.\n**Maître :** Les coups spéciaux réussis rendent 0.5 PE.' },
  'sec_Apprentissage': { desc: 'Apprendre plus vite et partager ses connaissances.', effet: '**Novice :** +1 compétence d\'aventure maximum.\n**Adepte :** +2 compétences d\'aventure maximum.\n**Expert :** +3 compétences d\'aventure maximum.\n**Maître :** Permet d\'apprendre à un joueur une connaissance ou un coup spécial.' },
  'mar_Dagues': { desc: 'Maîtriser les dagues et les attaques sournoises.', effet: '**Adepte :** +0.5 dégâts. Retire le malus dague + arme contre ennemi armé (réduit à 1 avec une seule dague). Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Retire le malus contre un ennemi armé. Attaques sournoises : 4x les dégâts (*5 en maître).\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Pugilat': { desc: 'Se battre à mains nues avec efficacité.', effet: '**Adepte :** +0.5 dégâts. Retire le malus mains nues contre ennemi armé (réduit à 1 avec cestes). Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Mains nues sur d15. Si infusé : poings touchent les spectres. Les 10 à mains nues ne sont plus des échecs.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Escrime': { desc: 'Maîtriser l\'épée avec précision et technique.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. L\'épée ignore l\'effet des casques.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Hache': { desc: 'Manier les haches pour des coups tranchants et brutaux.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Les critiques infligent toujours une blessure même si l\'ennemi fait sous 10.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Contondant': { desc: 'Manier masses et marteaux pour briser les défenses.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Les masses ignorent 1 point de défense.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Bâton': { desc: 'Utiliser le bâton pour contrôler et sonner les adversaires.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Tout échec contre un bâton (10+ contre réussite) sonne l\'ennemi.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Hast': { desc: 'Manier les armes d\'hast pour contrôler la distance.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. En cas d\'égalité, la lance est la plus longue arme et touche.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Fouet': { desc: 'Utiliser le fouet pour déstabiliser et renverser les ennemis.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Critiques ou blessures font vaciller l\'ennemi. Les blessures graves le mettent au sol.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Armes de lancer': { desc: 'Lancer des armes avec précision et puissance.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Peut utiliser des dagues, haches ou lances à une main comme armes de lancer.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Archerie': { desc: 'Maîtriser l\'arc pour des tirs précis et déstabilisants.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Déstabiliser ne demande plus 3 pts de différence, seulement 1.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Armes à feu': { desc: 'Manier les armes à feu avec précision et efficacité.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Les balles traversent l\'armure infligeant la moitié basse des dégâts sans faire de blessure.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Frondes': { desc: 'Utiliser la fronde pour ignorer la protection des casques.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Les frondes ignorent la protection des casques.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Armes à Énergie': { desc: 'Manier armes d\'Amok et blasters avec maîtrise.', effet: '**Adepte :** +0.5 dégâts. Permet d\'apprendre des coups spéciaux.\n**Expert :** Réduit le jet de 1. Armes d\'Amok ignorent la résistance. Blasters : pas de munitions consommées avec 3 ou moins au jet.\n**Maître :** +1 dégât. Donne un dé d\'avantage.' },
  'mar_Bouclier': { desc: 'Utiliser le bouclier pour se défendre efficacement.', effet: '**Adepte :** +0.5 PA.\n**Expert :** Bonus de 1 aux jets de défense.\n**Maître :** En cas de défense au corps à corps, donne un dé d\'avantage.' },
};
function getCompMeta(prefix, name) {
  const key = prefix + name;
  const saved = data._compMeta?.[key];
  const def = DEFAULT_COMP_META[key] || { desc: '', effet: '' };
  // Si pas de données sauvegardées, retourner les défauts
  if (!saved) return def;
  // Si sauvegardé mais un champ est vide, prendre le défaut pour ce champ
  return {
    desc:  saved.desc  || def.desc,
    effet: saved.effet || def.effet,
  };
}
